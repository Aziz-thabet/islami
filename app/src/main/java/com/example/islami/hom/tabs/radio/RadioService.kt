...
class RadioService : Service() {
    ...
    private fun createNotification(name: String) {
        ...
        remoteView.setTextViewText(R.id.notification_title, getString(R.string.app_name))
        remoteView.setTextViewText(R.id.notification_description, name)
        remoteView.setImageViewResource(
            R.id.play_notification,
            if (mediaPlayer.isPlaying) R.drawable.pause else R.drawable.play
        )
        remoteView.setOnClickPendingIntent(R.id.play_notification, getPlayPendingIntent())
